...
setup(
    ...
    author_email='davben@prometheux.co.uk, teodoro.baldazzi@prometheux.co.uk, support@prometheux.co.uk',
    description='Model Context Protocol (MCP) server for Prometheux - enabling AI agents to interact with ontologies and reasoning',
